        ...
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="animate-fade-in-up">
            ...
            <p className="mt-6 max-w-xl text-base leading-relaxed text-gray-300 sm:text-lg">
              Alyntis brings structured, hands-on technology learning into schools — helping
              students move from using technology to understanding, designing and building with it.
            </p>
