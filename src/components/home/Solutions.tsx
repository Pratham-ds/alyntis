import { ArrowRight, Bot, BrainCircuit, Cpu, GraduationCap, Plane, Wifi, Wrench, Boxes } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl font-bold leading-tight text-navy-900 sm:text-4xl">
              Everything a school needs to build a <span className="text-gradient">maker culture.</span>
            </h2>
            <p className="mt-4 text-base leading-relaxed text-gray-600 sm:text-lg">
              Alyntis combines structured programs, emerging technologies and practical projects to make technology education easier to deliver and easier to understand.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal delay={250}>
          <div className="mt-8 flex justify-center">
            <Button to="/schools" variant="outline" size="md">
